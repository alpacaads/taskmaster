...
window.Scenes = (function () {
  ...
  const PROMPTS = {
    ...
    meet_maya_card:      "POV first-sight character card from a flashlight's perspective in a dim concrete stairwell at night: tight chest-up portrait of Maya — a tough late-20s woman, messy shoulder-length dark red hair, green eyes, faint scar through one eyebrow, wearing a faded olive army jacket over a grey undershirt, a hunting knife on her belt — caught in the flashlight beam, unflinching, waiting, dust suspended in the beam of light, peeling paint behind her, chiaroscuro lighting, photorealistic, painterly, in the style of The Last of Us, portrait focus on her face",
    meet_nora_card:      "POV first-sight character card inside a walk-in freezer of an abandoned supermarket, flashlight beam finding her face: tight chest-up portrait of Nora — a wary ten-year-old girl, messy copper-brown hair in a loose ponytail, big hazel eyes wide with fear, dirt-smudged cheeks, oversized grey hoodie under a small olive jacket — pressed into a corner of tipped steel shelving, small hands gripping a kitchen knife far too big for her, breath fogging in the cold air, painterly cinematic, in the style of The Last of Us, portrait focus on her face",
    meet_vega_card:      "POV first-sight character card from the view of an approaching survivor at a fortified camp's chainlink gate: tight chest-up portrait of Captain Vega — a hardened mid-30s woman, black hair pulled back tight, sharp grey eyes, a thin scar along her cheekbone, wearing tactical fatigues with a captain's patch on the shoulder — aiming a scoped rifle directly at the camera with rock-steady hands, jaw set, razor wire and pine forest slightly out of focus behind her, warm dusk rim light on her face, dramatic low-key lighting, photorealistic, painterly, in the style of The Last of Us, portrait focus on her face",
    meet_ren_card:       "POV first-sight character card inside a converted shipping-container medbay at night, warm hanging lamp overhead: tight chest-up portrait of Ren — a gentle mid-20s woman, messy dark brown hair tucked behind one ear, warm brown eyes, faint freckles, a small silver stethoscope around her neck, wearing a grey medic's scrub top under a worn olive jacket — patting the cot beside her with a tired kind smile, medical supplies and a propped acoustic guitar slightly out of focus behind her, painterly cinematic, in the style of The Last of Us, portrait focus on her face",
    ...
    chore_done_perimeter: "interior of a tactical command tent at dusk lit by a hurricane lamp, Captain Vega in fatigues spreading a hand-drawn map across a folding table, a survivor leaning in to study a marked hospital, and Ren — a dark-haired young medic with a clipboard balanced on her knee — sitting just within the lamp's circle of light, calm disappointed attention, cinematic",
