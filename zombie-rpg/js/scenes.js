...
window.Scenes = (function () {
  ...
  const PROMPTS = {
    ...
    briefing_approach_medbay:    "intimate moment as a survivor steps into a dim command tent at dusk, Maya — a red-haired woman in an army jacket — sitting alone in the corner on an ammo crate, breaking down a rifle with deliberate care, parts laid out on an oil cloth, her eyes pointedly not on him, hurricane lamp glow, quiet cold tension between them, cinematic portrait",
    briefing_approach_perimeter: "intimate moment as a survivor steps into a dim command tent at dusk, Ren — a dark-haired young medic in a grey scrub top under an olive jacket — sitting on a folding stool with a clipboard balanced on her knee, hurricane lamp light haloing her hair, quiet disappointed attention, warm intimate portrait, cinematic",
    briefing_approach_kitchen:   "intimate moment as a survivor steps into a dim command tent at dusk holding a steaming mug, Ren wordlessly sliding a folding chair out for him without meeting his eye, Maya across the table with her back half-turned, hurricane lamp glow, the map on the folding table between them, quiet distant chill, cinematic portrait",
